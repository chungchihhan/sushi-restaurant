        ...
        <div className="menu-button-overlay" onClick={handleOutsideClick}>
            <div className="menu-button-content">
                ...
                <Link to="/menu" className='single-menu-button-link'>
                    <div className='single-menu-button'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="currentColor" className="bi bi-passport" viewBox="0 0 16 16">
                ...
                <Link to="/" className='single-menu-button-link'>
                    <div className='single-menu-button'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="currentColor" className="bi bi-box-arrow-right" viewBox="0 0 16 16">
                ...
                <Link to="/" className='single-menu-button-link'>
                    <div className='single-menu-button'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="currentColor" className="bi bi-cart" viewBox="0 0 16 16">
