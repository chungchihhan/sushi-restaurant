                ...
                <form onSubmit={handleSubmit}>
                    <div className='signup-small-container'>
                        ...
                        <div className='input-container'>
                            <input type="text" name="name" value={formData.name} onChange={handleChange} placeholder="工號"/>
                        </div>
                        <div className='input-container'>
                        ...
                        <div className='input-container'>
                            <select name="role" value={formData.role} onChange={handleChange} className='abc'>    
